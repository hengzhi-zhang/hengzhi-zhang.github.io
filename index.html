  ...
  <head>
    <style>
      ...
      header {
        ...
        color: #92977E; <!-- color of "Hengzhi Zhang"  -->
        padding: 20px;
        text-align: center;
      }
      main {
      ...
      section p {
        ...
        <!-- this is the font for my bio section, which is courier -->
      }
      h1{
        font-family: "sans-serif", sans-serif;
        font-weight: bold
        <!-- this is the font for my labels section, which is courier -->
        }
      h2{
        font-family: "sans-serif", sans-serif;
        <!-- this is the font for my other labels section, which is courier -->
        }
      section ul {
        font-family: "sans-serif", sans-serif;
        <!-- this is the font for my skills section, which is courier -->
        }
      button{
        font-family: "sans-serif", sans-serif;
        <!-- this is the font for my button, which is courier -->
        font-size: 16px
        <!-- specifies font size -->
        }
      button.contact {
